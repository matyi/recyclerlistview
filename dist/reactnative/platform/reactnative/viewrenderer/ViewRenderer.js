...
var ViewRenderer = /** @class */ (function (_super) {
    ...
    ViewRenderer.prototype.renderCompat = function () {
        var position = this.props.isRTL ? { right: this.props.x } : { left: this.props.x };
        return this.props.forceNonDeterministicRendering ? (React.createElement(react_native_1.View, { ref: this._setRef, onLayout: this._onLayout, style: __assign({ flexDirection: this.props.isHorizontal ? "column" : "row" }, position, { position: "absolute", top: this.props.y }, this.props.styleOverrides, this.animatorStyleOverrides) }, this.renderChild())) : (React.createElement(react_native_1.View, { ref: this._setRef, style: __assign({}, position, { position: "absolute", top: this.props.y, height: this.props.height, width: this.props.width }, this.props.styleOverrides, this.animatorStyleOverrides) }, this.renderChild()));
    };
